...
#define _ADD_TOKEN(cls, name) \
    cls.add_static_property(#name, +[]() { return UsdSourceIdSchemaTokens->name.GetString(); });

void wrapUsdSourceIdSchemaTokens()
{
    pxr_boost::python::class_<UsdSourceIdSchemaTokensType, pxr_boost::python::noncopyable>
